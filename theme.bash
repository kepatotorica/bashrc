...
# POWERLINE_LEFT_SEPARATOR=" " # this adds the arrow inbetween each part of the prompt
PROMPT_CHAR=${POWERLINE_PROMPT_CHAR:="\n😱"}
POWERLINE_LEFT_SEPARATOR=" "
POWERLINE_PROMPT="last_status user_info cwd scm"

USER_INFO_SSH_CHAR=" "
USER_INFO_PROMPT_COLOR="R W"
...
SCM_PROMPT_AHEAD="↑"
SCM_PROMPT_BEHIND="↓"
SCM_PROMPT_CLEAN_COLOR="G G"
SCM_PROMPT_DIRTY_COLOR="R R"
SCM_PROMPT_AHEAD_COLOR=""
SCM_PROMPT_BEHIND_COLOR=""
SCM_PROMPT_STAGED_COLOR="Y Y"
SCM_PROMPT_UNSTAGED_COLOR="R R"
SCM_PROMPT_COLOR=${SCM_PROMPT_CLEAN_COLOR}

CWD_PROMPT_COLOR="B C"

STATUS_PROMPT_COLOR="W R B"
STATUS_PROMPT_ERROR="✘"
STATUS_PROMPT_ERROR_COLOR="R R B"
STATUS_PROMPT_ROOT="⚡"
STATUS_PROMPT_ROOT_COLOR="Y Y B"
STATUS_PROMPT_JOBS="●"
STATUS_PROMPT_JOBS_COLOR="Y Y B"
...
function __powerline_user_info_prompt {
  ...
  if [[ -n "${SSH_CLIENT}" ]]; then
    user_info="${USER_INFO_SSH_CHAR}\u@"
  else
    user_info="\u@"
  fi
